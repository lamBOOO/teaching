...
# ╔═╡ 5cd5ca38-bce9-48cd-8bee-58957fbecc0e
...
1. Choose start vector $x_0 \in \mathbb{R}^n \setminus \{0\}$
1. While $k < k_\max \wedge \text{error} > \tau$ do
...
# ╔═╡ ce567b28-e424-41a3-91fa-6f32287588f7
eigen(A)
...
- Matrix $A$ has ratio $q=$ $(abs(eigvals(A)[end-1]/eigvals(A)[end])) = λ₂/λ₁
...
# ╔═╡ 4162cdde-ed32-4012-a446-307e2408112b
eigen(B).values

# ╔═╡ f027c736-655a-4548-a3d4-94f99929cddd
B
...
manifest_format = "2.0"
project_hash = "5fd1966b4f63e8d6fbfd63e22f6d5fb2df7f770e"
